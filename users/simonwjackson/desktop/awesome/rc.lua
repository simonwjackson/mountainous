...
awful.spawn.with_shell("nix-shell -p hsetroot --run 'hsetroot -cover ~/downloads/jonatan-pie-3l3RwQdHRHg-unsplash.jpg'")

beautiful.font = "NotoSans Nerd Font Bold 11"
...
awful.screen.connect_for_each_screen(function(s)
  ...
  s.simon = wibox({
    ...
    widget = wibox.container.place(mytextclock)
  })

  -- Create the wibox
  -- s.mywiboxXXX = awful.wibar({
  --   position = "top",
  --   screen = s,
  --   bg = "#00000000",
  -- })
...
-- awful.key({ modkey }, "-",
--     function() scratch.toggle("kitty --class scratch-term") end, {
--     description = "toggle term",
--     group = "awesome"
-- }),

  awful.key({ modkey }, "=",
    function() scratch.toggle("kitty --class scratch-wiki-term vimwiki-journal") end, {
...
awful.rules.rules = {
  {
    ...
    properties = {
      width = awful.screen.focused().workarea.width * 0.66,
      height = awful.screen.focused().workarea.height * 0.66,
      floating = true
    },
    callback = function(c) awful.placement.centered(c, nil) end,
  },
  {
    rule = { instance = "scratch-journal" },
    properties = {
      width = awful.screen.focused().workarea.width * 0.66,
      height = awful.screen.focused().workarea.height * 0.66,
      floating = true
