  ...
  config = mkIf cfg.enable (mkMerge [
    {
      assertions =
        [
          {
            ...
            message = "mountainous.sonarr requires mountainous.features.media.enable = true";
          }
        ]
        ...
        ++ optional cfg.vpn.enable {
          ...
          message = "mountainous.sonarr requires mountainous.features.vpn-ns.enable = true when vpn.enable = true";
        }
        ++ optional cfg.proxy.enable {
          assertion = config.mountainous.features.tsnet-proxy.enable or false;
          message = "mountainous.sonarr requires mountainous.features.tsnet-proxy.enable = true when proxy.enable = true";
        }
        ++ optional cfg.downloadClients.nzbget.enable {
          assertion = config.mountainous.features.nzbget.enable;
          message = "mountainous.sonarr.downloadClients.nzbget requires mountainous.features.nzbget.enable = true";
        }
        ++ optional cfg.downloadClients.transmission.enable {
          assertion = config.mountainous.features.transmission.enable;
          message = "mountainous.sonarr.downloadClients.transmission requires mountainous.features.transmission.enable = true";
        };
