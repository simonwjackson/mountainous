{
  ...
  socks5_proxy_url = ""
  permissions = ""
  download_dir = ${rootDir}/Downloads/incomplete
  download_free = ""
  complete_dir = ${rootDir}/Downloads/complete
  complete_free = ""
  fulldisk_autoresume = 0
  script_dir = "${rootDir}/script"
  nzb_backup_dir = "${rootDir}/script"
  admin_dir = ${rootDir}/admin
  backup_dir = "${rootDir}/backup"
  dirscan_dir = "${rootDir}/dirscan"
  dirscan_speed = 5
  password_file = ""
  ...
  ipv6_servers = 1
  url_base = ""
  host_whitelist = ${builtins.concatStringsSep "," hosts}
  local_ranges = ,
  max_url_retries = 10
  ...
  displayname = us.newsdemon.com
  host = us.newsdemon.com
  port = 563
  timeout = 60
  username = @@NEWSDEMON_USER@@
  password = @@NEWSDEMON_PASS@@
  connections = 8
  ssl = 1
  ssl_verify = 2
  ssl_ciphers = ""
